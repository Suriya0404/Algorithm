(function () {
    var n;
    n = !1;
    window.tableau = window.tableau || {}, function (n) {
        function t() {
            for (var i, n, r = document.getElementsByTagName("script"), t = r.length - 1; t >= 0; t -= 1) if (i = r[t], /viz_v1\.js/.test(i.src)) break;
    ...
    window.tableau._apiLoaded || (window.tableau._apiLoaded = !0, function () {
        ...
        function et(n) {
            var i, t, u, r;
            for (r = [[/&/g, "&amp;"], [/</g, "&lt;"], [/>/g, "&gt;"], [/"/g, "&quot;"], [/'/g, "&#39;"], [/\//g, "&#47;"]], i = n || "", t = 0, u = r.length; t < u; t++) i = i.replace(r[t][0], r[t][1]);
            return i
        }
        ...
        function lt(n, t) {
            for (var i = 0; n[i] !== undefined; i += 1) if (n[i] === t) return n.splice(i, 1), !0;
            return !1
        }

        function l(n) {
            var i = n.getBoundingClientRect(), t = f(n), r = parseInt(t.paddingLeft, 10) || 0,
                e = parseInt(t.paddingRight, 10) || 0, u = parseInt(t.paddingTop, 10) || 0,
                o = parseInt(t.paddingBottom, 10) || 0, s = parseInt(t.borderLeftWidth, 10) || 0,
        ...
        function it(n, t) {
            var i = Math.max(n.left, t.left), r = Math.max(n.top, t.top),
                u = Math.min(n.left + n.width, t.left + t.width), f = Math.min(n.top + n.height, t.top + t.height);
            return u <= i || f <= r ? {left: 0, top: 0, width: 0, height: 0} : {
                left: i,
                top: r,
                width: u - i,
                height: f - r
        ...
        function pt(n, t) {
            var i = tableau.vizs[n]._loadOrder, r = tableau.vizs[t]._loadOrder;
        ...
        function dt() {
            ...
            function i(i) {
                if (typeof i.data == "string" || i.data instanceof String) for (var u = i.data.split(","), r = 0, f; r < u.length;) n || u[r] !== "tableau.completed" && u[r] !== "completed" || (n = !0, t(i.source, -1)), u[r] === "sf?" && (f = u[++r], t(i.source, f)), ++r
            }
        ...
        i.prototype._createAndAppendIframe = function () {
            ...
            if (!e(this._objectElement)) {
                ...
                return n.style.cssText = this._objectElement.style.cssText, n.style.margin = "0px", n.style.padding = "0px", n.style.border = "none", this.sizeIframeToObjectElement(n), r = navigator.userAgent, h = r.indexOf("WebKit") >= 0, s = r.indexOf("Chrome") >= 0, c = r.indexOf("Safari") >= 0 || h && !s, c && n.addEventListener("mousewheel", function () {
                }), this._ensurePlaceholderDiv() && this._placeholderDiv.appendChild(n), n
            }
        };
        ...
        window.tableau.Viz.prototype.load = function () {
            var n = "&:loadOrderID=" + t, i = window.top === window.self ? "" : "&:increment_view_count=no";
